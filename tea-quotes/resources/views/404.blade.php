...
<body>
<header id="top" class="header" style="background: url('/img/1.jpg') no-repeat center center scroll">
    <div class="text-vertical-center">
        <h1 class="text">Sorry we couldn't find the quote you were looking for</h1>
        <h3 class="author"><a href="/" title="Permalink">Go back to today's quote</a></h3>
    </div>
</header>
<script>
